...
const Login = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      const signingUp = await axios.post("http://localhost:3000/auth/login", userCredentials);
      console.log(signingUp.data.user);
      localStorage.setItem("users", JSON.stringify(signingUp.data.user));
